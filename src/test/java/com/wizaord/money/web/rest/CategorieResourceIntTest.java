...
public class CategorieResourceIntTest {
    ...
    private static final Boolean DEFAULT_ABONNEMENT_REGULIER = false;
    private static final Boolean UPDATED_ABONNEMENT_REGULIER = true;

    private static final Integer DEFAULT_CATEGORIE_PERE = 1;
    private static final Integer UPDATED_CATEGORIE_PERE = 2;
    ...
    public void setup() {
        ...
        CategorieResource categorieResource = new CategorieResource(categorieRepository);
    ...
    public void createCategorie() throws Exception {
        ...
        assertThat(testCategorie.isIsCredit()).isEqualTo(DEFAULT_IS_CREDIT);
        assertThat(testCategorie.isAbonnementRegulier()).isEqualTo(DEFAULT_ABONNEMENT_REGULIER);
        assertThat(testCategorie.getCategoriePere()).isEqualTo(DEFAULT_CATEGORIE_PERE);
    }
    ...
    public void getAllCategories() throws Exception {
        ...
        restCategorieMockMvc.perform(get("/api/categories?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].abonnementRegulier").value(hasItem(DEFAULT_ABONNEMENT_REGULIER.booleanValue())))
            .andExpect(jsonPath("$.[*].categoriePere").value(hasItem(DEFAULT_CATEGORIE_PERE)));
    }
    ...
    public void getCategorie() throws Exception {
        ...
        restCategorieMockMvc.perform(get("/api/categories/{id}", categorie.getId()))
            ...
            .andExpect(jsonPath("$.abonnementRegulier").value(DEFAULT_ABONNEMENT_REGULIER.booleanValue()))
            .andExpect(jsonPath("$.categoriePere").value(DEFAULT_CATEGORIE_PERE));
    }
    ...
    public void updateCategorie() throws Exception {
        ...
        updatedCategorie
            ...
            .abonnementRegulier(UPDATED_ABONNEMENT_REGULIER)
            .categoriePere(UPDATED_CATEGORIE_PERE);
        ...
        assertThat(testCategorie.isIsCredit()).isEqualTo(UPDATED_IS_CREDIT);
        assertThat(testCategorie.isAbonnementRegulier()).isEqualTo(UPDATED_ABONNEMENT_REGULIER);
        assertThat(testCategorie.getCategoriePere()).isEqualTo(UPDATED_CATEGORIE_PERE);
    }
